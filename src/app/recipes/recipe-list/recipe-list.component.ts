...
export class RecipeListComponent {
  recipes: Recipe[] = [
    ...
    new Recipe('A Test Recipe', 'This is simply a test', 'https://assets.bonappetit.com/photos/57acc9d3f1c801a1038bc775/master/w_4000,h_2667,c_limit/real-tuna-casserole-USE-THIS.jpg'),
  ];
}
